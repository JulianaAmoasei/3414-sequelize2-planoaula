...
router.put('/pessoas/:estudante_id/cancela', (req, res) => pessoaController.cancelaRegistroPessoa(req, res));
...
router.get('/pessoas/matriculas/lotadas', (req, res) => matriculaController.pegaTurmasLotadas(req, res));
